...
**hashing parameters defined in application.rb**

- `pbkdf2_algorithm`: the hashing algorithm used ("sha256")
- `pbkdf2_iterations`: the number of iterations to run (600_000)
